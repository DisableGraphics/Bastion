                        ...
                        const char* violation)
{
	...
	libk_ubsan_abort(violation, location->filename, location->line,
	                 location->column);
#else
	log(ERROR, "UBSAN ABORT: file: %s at %d:%d: %s", location->filename, location->line, location->column, violation);
	kn::panic("UNDEFINED BEHAVIOUR DETECTED");
#endif
}

#define ABORT_VARIANT(name, params, call) \
__attribute__((noreturn)) \
extern "C" void __ubsan_handle_##name##_abort params \
{ \
...
extern "C" void __ubsan_handle_type_mismatch(void* data_raw,
                                  void* pointer_raw)
{
...
extern "C" void __ubsan_handle_type_mismatch_v1(void* data_raw,
                                     void* pointer_raw)
{
...
extern "C" void __ubsan_handle_alignment_assumption(void* data_raw,
                                         void* pointer_raw,
                                         void* alignment_raw,
                                         void* offset_raw)
{
...
extern "C" void __ubsan_handle_add_overflow(void* data_raw,
                                 void* lhs_raw,
                                 void* rhs_raw)
{
...
extern "C" void __ubsan_handle_sub_overflow(void* data_raw,
                                 void* lhs_raw,
                                 void* rhs_raw)
{
	struct ubsan_overflow_data* data = (struct ubsan_overflow_data*) data_raw;
...
extern "C" void __ubsan_handle_mul_overflow(void* data_raw,
                                 void* lhs_raw,
                                 void* rhs_raw)
{
	struct ubsan_overflow_data* data = (struct ubsan_overflow_data*) data_raw;
...
extern "C" void __ubsan_handle_negate_overflow(void* data_raw,
                                    void* old_value_raw)
{
	struct ubsan_overflow_data* data = (struct ubsan_overflow_data*) data_raw;
...
extern "C" void __ubsan_handle_divrem_overflow(void* data_raw,
                                    void* lhs_raw,
                                    void* rhs_raw)
{
	struct ubsan_overflow_data* data = (struct ubsan_overflow_data*) data_raw;
...
extern "C" void __ubsan_handle_shift_out_of_bounds(void* data_raw,
                                        void* lhs_raw,
                                        void* rhs_raw)
{
...
extern "C" void __ubsan_handle_out_of_bounds(void* data_raw,
                                  void* index_raw)
{
...
__attribute__((noreturn))
extern "C" void __ubsan_handle_builtin_unreachable(void* data_raw)
{
...
__attribute__((noreturn))
extern "C" void __ubsan_handle_missing_return(void* data_raw)
{
	struct ubsan_unreachable_data* data =
		(struct ubsan_unreachable_data*) data_raw;
...
extern "C" void __ubsan_handle_vla_bound_not_positive(void* data_raw,
                                           void* bound_raw)
{
...
extern "C" void __ubsan_handle_float_cast_overflow(void* data_raw,
                                        void* from_raw)
{
...
extern "C" void __ubsan_handle_load_invalid_value(void* data_raw,
                                       void* value_raw)
{
...
extern "C" void __ubsan_handle_implicit_conversion(void* data_raw,
                                        void* src_raw,
                                        void* dst_raw)
{
...
extern "C" void __ubsan_handle_invalid_builtin(void* data_raw)
{
...
extern "C" void __ubsan_handle_invalid_objc_cast(void* data_raw,
                                      void* pointer_raw)
{
	struct ubsan_invalid_builtin_data* data =
		(struct ubsan_invalid_builtin_data*) data_raw;
...
extern "C" void __ubsan_handle_function_type_mismatch(void* data_raw,
                                           void* value_raw)
{
...
extern "C" void __ubsan_handle_nonnull_return(void* data_raw)
{
                                      ...
                                      void* location_raw)
{
	struct ubsan_nonnull_return_data* data =
		(struct ubsan_nonnull_return_data*) data_raw;
	(void) data;
	struct ubsan_source_location* location = (ubsan_source_location*)location_raw;
	ubsan_abort(location, "null return");
}

extern "C" void __ubsan_handle_nullability_return_v1(void* data_raw,
                                          void* location_raw)
{
	struct ubsan_nonnull_return_data* data =
		(struct ubsan_nonnull_return_data*) data_raw;
...
#if !(defined(__GNUC__) && __GNUC__< 6)
extern "C" void __ubsan_handle_nonnull_arg(void* data_raw)
#else
extern "C" void __ubsan_handle_nonnull_arg(void* data_raw,
                                intptr_t index_raw)
#endif
...
extern "C" void __ubsan_handle_nullability_arg(void* data_raw)
{
	struct ubsan_nonnull_arg_data* data =
		(struct ubsan_nonnull_arg_data*) data_raw;
...
extern "C" void __ubsan_handle_pointer_overflow(void* data_raw,
                                     void* base_raw,
                                     void* result_raw)
{
...
extern "C" void __ubsan_handle_cfi_bad_icall(void* data_raw,
                                  void* value_raw)
{
...
extern "C" void __ubsan_handle_cfi_check_fail(void* data_raw,
                                   void* function_raw,
...
extern "C" void __ubsan_handle_cfi_bad_type(void* data_raw,
                                 void* function_raw,
                                 uintptr_t vtable_is_valid,
